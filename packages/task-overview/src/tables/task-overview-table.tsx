...
interface TaskOverviewTableProps<TData, TValue> {
...
export function TaskOverviewTable<TData, TValue>({
  columns,
  data,
  onSort,
  sortConfig
}: TaskOverviewTableProps<TData, TValue>) {
                    ...
                    <TableHead key={header.id}>
                      {header.isPlaceholder ? null : (
                        ...
                        >
                          ...
                          {canSort && sortConfig && sortConfig.key === header.id && (
                            <span className="ml-2">
